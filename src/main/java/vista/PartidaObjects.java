...
import controlador.ControladorPartidaObjects;
 ...
 * @author ezequielpena
 */
public class PartidaObjects extends javax.swing.JFrame {

    /**
     * Creates new form Partida
     */
    ControladorPartidaObjects objControladorPartidaObjects;
...
//        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    public void inicializarControlador(){
        this.objControladorPartidaObjects = new ControladorPartidaObjects(this,objTablero,objTableroBot);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartidaObjects.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PartidaObjects().setVisible(true);
            }
        });
    }
