...
public class About extends javax.swing.JFrame {
    ...
    ControladorAbout objControladorAbout;
    public About() {
        this.setContentPane(fondo);
        initComponents();
        this.setLocationRelativeTo(this);
        this.objControladorAbout = new ControladorAbout(this);
    }
    ...
    class FondoPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            image = new ImageIcon(getClass().getResource("/fondos/vista__about.png")).getImage();
